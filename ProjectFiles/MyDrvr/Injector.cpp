...
namespace INJ_CODE
{
    ...
    static NTSTATUS Injection(PINJECTION_INFO info)
    {
        NTSTATUS status;
    ...
    static void InjKernelRoutine(PKAPC Apc, PKNORMAL_ROUTINE* NormalRoutine, PVOID* NormalContext, PVOID* SystemArgument1, PVOID* SystemArgument2)
    {
